...
const Hero = () => {
   return (
      <section className="min-h-[100dvh] w-full flex flex-col justify-center items-start px-6 md:px-20 relative overflow-hidden bg-background py-20 md:py-0">
         {/* Background decoration or visual */}
         <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[500px] md:h-[500px] bg-accent-purple/20 blur-[120px] rounded-full pointer-events-none" />
         ...
         >
            ...
            <h1 className="text-4xl md:text-7xl font-bold font-mono tracking-tighter mb-6 leading-tight">
